...
contract CakeStake is ReentrancyGuard {
     ...
     */
    function stakeToEarn(address to, uint256 _amount) external nonReentrant {
     ...
     */
    function quit(address to, uint256 _amount) external nonReentrant {
        require(_amount > 0, "Amount must be greater than 0");

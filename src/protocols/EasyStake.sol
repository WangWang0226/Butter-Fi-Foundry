...
contract EasyStake is ReentrancyGuard {
     ...
     */
    function depositTokens(address to, uint256 _amount) external nonReentrant {
     ...
     */
    function withdrawTokens(address to, uint256 _amount) external nonReentrant {
        require(_amount > 0, "Amount must be greater than 0");
